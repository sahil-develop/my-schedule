...
const PROTECTED_PATHS = ['/dashboard', '/schedule', '/analytics', '/dsa', '/jobs', '/learning', '/goals', '/reports', '/settings'];
...
export const config = {
  matcher: ['/dashboard', '/schedule', '/analytics', '/dsa', '/jobs', '/learning', '/goals', '/reports', '/settings', '/login', '/register'],
};
